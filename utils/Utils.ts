...
export const serverSide404 = (res: any) => {
    res.statusCode = 302
...
export const getCanonicalPath = () => {
    ...
    return `https://spikeslotgratis.com${router.asPath}`
}
...
export const exitFullscreen = () => {
    ...
    if (elem.exitFullscreen && elem.fullscreen) {
        elem.exitFullscreen()
    } else if (elem.mozCancelFullScreen && elem.fullscreen) {
        /* Firefox */
        elem.mozCancelFullScreen()
    } else if (elem.webkitExitFullscreen && elem.fullscreen) {
        /* Chrome, Safari and Opera */
        elem.webkitExitFullscreen()
    } else if (elem.msExitFullscreen && elem.fullscreen) {
        /* IE/Edge */
