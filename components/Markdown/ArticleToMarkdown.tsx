...
const ArticleToMarkdown: FunctionComponent<Props> = ({ content, style, isBakeca = false }) => {
    ...
    const replaceWithCustomElement = (props: any) => {
        ...
        if (elementType === 'googleForm') {
            ...
            return <iframe width={'100%'} height={'1450px'} style={{ marginTop: '2rem', }} src='https://docs.google.com/forms/d/e/1FAIpQLSdcTMybOWdvHooCcICxNPREZZHSbfH05UxrfXFwufjYkKLmDg/viewform?embedded=true' />
        }
