                ...
                return(
                    <div>
                        ...
                        <ResultTileStyleProvider type='bonus'>
                            <div className='tile-container' onClick={() => Router.push(`/guida/bonus-benvenuto-casino-starvegas/${contextCountry}`)}>
            ...
            case 'row':
                return(
                    <div>
                        ...
                        <ResultTileStyleProvider type='bonus'>
                            <div className='tile-container' onClick={() => Router.push(`/guida/cobra-casino-review/${contextCountry}`)}>
                                <img style={{ width: '36px', height: '36px' }} src={injectCDN('https://spike-images.s3.eu-central-1.amazonaws.com/cobracasino-circular-image_c3d7484779.jpeg')} />
                                <h3>{'Cobra Casino'}</h3>
                                <h3 className='type'>{t("Bonus Guide")}</h3>
                            </div>
                        </ResultTileStyleProvider>
                        ...
                        <ResultTileStyleProvider type='bonus'>
                            <div className='tile-container' onClick={() => Router.push(`/guida/buran-casino-review/${contextCountry}`)}>
                                <img style={{ width: '36px', height: '36px' }} src={injectCDN('https://spike-images.s3.eu-central-1.amazonaws.com/buran-casino-circular-image_48f4dba870.jpeg')} />
                                <h3>{'Buran Casino'}</h3>
                                <h3 className='type'>{t("Bonus Guide")}</h3>
                            </div>
                        </ResultTileStyleProvider>
