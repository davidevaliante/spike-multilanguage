...
const SlotListSearchInput: FunctionComponent<Props> = ({ onSearchChange, value, onSearchFocusChange, searchResults, countryCode }) => {
        ...
        <Wrapper hasFocus={hasFocus} onClick={() => !hasFocus && document.getElementById('slotListSearchField')!.focus()}>
            <Container>
                <Search
                    ...
                    placeholder={t("Search for a Slot")}
...
export default SlotListSearchInput