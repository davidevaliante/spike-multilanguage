...
interface IMegaRouletteCard {
    stat: MegaRouletteStat
    totalSpinsConsidered: number
    timeFrame: string
}

const MegaRouletteCard: FunctionComponent<IMegaRouletteCard> = ({ stat, totalSpinsConsidered, timeFrame }) => {
...
export default MegaRouletteCard
