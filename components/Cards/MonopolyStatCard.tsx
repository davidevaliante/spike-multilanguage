        ...
        case 'one':
            return (
                <img
                    width={_rectWidht}
                    height={_rectHeight}
                    src={injectCDN('https://spike-images.s3.eu-central-1.amazonaws.com/monopoly-1-card_1412ffb4dd.png')}
                />
            )
        case 'two':
            return (
                <img
                    width={_rectWidht}
                    height={_rectHeight}
                    src={injectCDN('https://spike-images.s3.eu-central-1.amazonaws.com/monopoly-2-card_fac87cd080.png')}
                />
            )
        case 'five':
            return (
                <img
                    width={_rectWidht}
                    height={_rectHeight}
                    src={injectCDN('https://spike-images.s3.eu-central-1.amazonaws.com/monopoly-5-card_53d38822d8.png')}
                />
            )
        case 'ten':
            return (
                <img
                    ...
                    height={_rectHeight}
                    src={injectCDN(
                        'https://spike-images.s3.eu-central-1.amazonaws.com/monopoly-10-card_b6b453773a.png'
                    )}
                />
            )
        case 'tworolls':
            return (
                <img
                    ...
                    height={_rectHeight}
                    src={injectCDN(
                        'https://spike-images.s3.eu-central-1.amazonaws.com/monopoly-2r-card_7607c7f4e2.png'
                    )}
                />
            )
        case 'fourrolls':
            return (
                <img
                    ...
                    height={_rectHeight}
                    src={injectCDN(
                        'https://spike-images.s3.eu-central-1.amazonaws.com/monopoly-4r-card_abbeacf82a.png'
                    )}
                />
            )
        case 'chance':
            return (
                <img
                    ...
                    height={_rectHeight}
                    src={injectCDN(
                        'https://spike-images.s3.eu-central-1.amazonaws.com/monopoly-chance-card_0faa3808a5.png'
                    )}
                />
            )
    }
