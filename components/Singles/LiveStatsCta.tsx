...
const LiveStatsCta: FunctionComponent<Props> = (props: Props) => {
    ...
    return (
        <div>
            <h2 className='font-serif text-primary-500 mx-2 lg:mx-0 mb-4 text-xl'>Live Stats</h2>
            <div className='flex flex-row max-w-[95vw] mb-12 pb-2 gap-2 mx-1 overflow-x-auto justify-between relative'>
                <ImgContainer>
                    <CTAImage
                ...
                <CTAImage
                    ...
                    src={injectCDN(
                        'https://spike-images.s3.eu-central-1.amazonaws.com/monopoly_active_e9d2a6d505.jpeg'
                    )}
                />
            </div>
        </div>
