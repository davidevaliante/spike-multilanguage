    ...
    return (
        <StyleProvider>
            <Head>
                ...
                <meta
                    name="description"
                    content={vltSlotListPage?.seo?.seoDescription}>
                </meta>
                ...
                <BodyContainer>
                    <MainColumn>
                       ...
                       {vltSlotListPage?.sliderSlots &&  <LazyLoad height={450} once offset={100}>
                        ...
                        {vltSlotListPage?.bottomArticle && <ArticleToMarkdown style={{ padding: '0rem 1rem' }} content={injectCDN(vltSlotListPage?.bottomArticle!)} />}
                    </MainColumn>
                    <RightColumn>
