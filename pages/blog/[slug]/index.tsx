...
interface Props {
  blogList: {
    seo: Seo;
    content:
    (DynamicArticle | DynamicBonusList | DynamicSlotList | DynamicVideo)[];
  };
  articles: Article[];
...
const BlogArticleList: FunctionComponent<Props> = (
  { blogList, bonusList, articles, _requestedCountryCode },
) => {
  ...
  return (
    <Fragment>
      <Head>
        ...
        <meta
          property="og:url"
          content={`https://spikeslot.com/blog/${_requestedCountryCode}`}
        />
