...
const BlogArticle: FunctionComponent<Props> = ({
  article,
  bonusList,
  ...
  return (
    <Fragment>
      <Head>
        ...
        <link
          rel="canonical"
          href={`https://spikeslot.com/blog/${article.slug}/${_requestedCountryCode}`}
        />
      ...
      <NavbarProvider
        currentPage={`/blog-article/${article.seo?.seoTitle}`}
      ...
      >
        <TopRowContainer>
          ...
          <ShareButtons
            ...
            image={
              article.seo?.shareImg
                ? article.seo.shareImg
                : injectCDN(article.image?.url)
            }
          />
        </TopRowContainer>
