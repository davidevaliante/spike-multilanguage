...
const index: FunctionComponent<Props> = (
  { seo, content, _requestedCountryCode },
) => {
  const [loading, setLoading] = useState(true);
  const { t, contextCountry, userCountry, setUserCountry, setContextCountry } =
  ...
  return (
    <Fragment>
      <Head>
        ...
        <link
          rel="canonical"
          href={`https://spikeslot.com/cookie-privacy-policy/${_requestedCountryCode}`}
        />
